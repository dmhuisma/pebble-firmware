...
#define NRF52840DK_SCREEN_RES (PBL_DISPLAY_WIDTH == 144 && PBL_DISPLAY_HEIGHT == 168)
...
#elif SPALDING_SCREEN_RES || NRF52840DK_SCREEN_RES
...
#elif SNOWY_SCREEN_RES || SPALDING_SCREEN_RES || NRF52840DK_SCREEN_RES
#if PBL_RECT
