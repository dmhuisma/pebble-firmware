...
static UARTDevice DBG_UART_DEVICE = {
  ...
  .rts_gpio = NRF_GPIO_PIN_MAP(0, 5),
  .cts_gpio = NRF_GPIO_PIN_MAP(0, 7),
...
/*  */
static I2CBusState I2C_IIC1_BUS_STATE = {};

static const I2CBusHal I2C_IIC1_BUS_HAL = {
  .twim = NRFX_TWIM_INSTANCE(1),
  .frequency = NRF_TWIM_FREQ_400K,
};

static const I2CBus I2C_IIC1_BUS = {
  .state = &I2C_IIC1_BUS_STATE,
  .hal = &I2C_IIC1_BUS_HAL,
  .scl_gpio = {
    .gpio = NRF5_GPIO_RESOURCE_EXISTS,
    .gpio_pin = NRF_GPIO_PIN_MAP(0, 26),
  },
  .sda_gpio = {
    .gpio = NRF5_GPIO_RESOURCE_EXISTS,
    .gpio_pin = NRF_GPIO_PIN_MAP(0, 27),
  },
  .name = "I2C_IIC1"
};
...
void board_early_init(void) {
  PBL_LOG(LOG_LEVEL_ERROR, "nrf52840dk early init");
